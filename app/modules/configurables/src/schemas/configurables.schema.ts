...
export const configurableSchemas: ConfigurableSchemas = {
  formSchema: [
    ...
    // ── Siloam: scoring thresholds (drive score band colors/labels) ─────────
    {
      fieldName: "scoreThresholds",
      type: "object",
      required: true,
      label: "Score Thresholds",
      fields: [
        { fieldName: "excellent", type: "number", required: true, label: "Excellent (min score)", min: 0, max: 100 },
        { fieldName: "good", type: "number", required: true, label: "Good (min score)", min: 0, max: 100 },
      ],
    },

    // ── Siloam: organizational scope (hospitals & units) ────────────────────
    {
      fieldName: "hospitals",
      type: "array",
      required: false,
    ...
    // ── Siloam: training course catalog (source for AI recommendations) ─────
    {
      fieldName: "courseCatalog",
      type: "array",
      required: false,
      ...
      item: {
        type: "object",
        fields: [
          { fieldName: "id", type: "string", required: true, label: "Course ID" },
          { fieldName: "title", type: "string", required: true, label: "Title" },
          { fieldName: "focus", type: "string", required: true, label: "Focus Area" },
          { fieldName: "duration", type: "string", required: false, label: "Duration" },
        ],
      },
    },

    // ── Siloam: feature flags ───────────────────────────────────────────────
    {
      fieldName: "enableLiveRecording",
      type: "boolean",
      required: false,
      label: "Enable Live Recording",
    },
    {
      fieldName: "enableCourseRecommendations",
      type: "boolean",
      required: false,
      label: "Enable Course Recommendations",
    },
  ],
};